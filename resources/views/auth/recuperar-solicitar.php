    ...
    <div class="max-w-4xl mx-auto mt-8">
        <div id="acceso" class="rounded-2xl overflow-hidden border border-white/20 shadow-2xl bg-primary-900/80 backdrop-blur-sm scroll-mt-20">
            ...
            <div class="p-6">
                ...
                <form method="POST" action="<?= url('auth/recuperar') ?>" class="max-w-md mx-auto space-y-4">
                    <!-- Campo oculto para identificar la solicitud de recuperación -->
                ...
                <div class="mt-5 pt-4 border-t border-white/10 text-center">
                    <p class="text-xs text-primary-50/40 flex items-center justify-center gap-2">
                        <i class="fa-solid fa-envelope-circle-check text-[#00eeff]/60"></i>
                        <span>📧 Recibirás un enlace en tu correo para restablecer tu contraseña</span>
                        <i class="fa-solid fa-envelope-circle-check text-[#00eeff]/60"></i>
                    </p>
                </div>
            </div>
