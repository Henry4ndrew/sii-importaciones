<!-- ============================================ -->
<!-- PORTADA DECORATIVA (SOLO EN DASHBOARD)       -->
<!-- ============================================ -->
<?php if (isset($mostrarPortada) && $mostrarPortada === true): ?>
<div class="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] h-56 md:h-72 overflow-hidden shadow-xl mb-6 bg-primary-900 -mt-10 z-0">
    <?php 
    $imgUrl = 'https://sii-importaciones.net/public/img/portadaAlibaba.webp';
    $fallbackUrl = url('public/img/portadaAlibaba.webp');
    ?>
